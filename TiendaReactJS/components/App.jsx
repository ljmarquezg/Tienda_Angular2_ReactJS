...
class App extends React.Component{
  ...
  render(){
    return(
      <div className="tienda row">
        <div className="container">
          <Route path="/tienda/catalogo" component={()=><Tienda actualizarDisponible={this.actualizarDisponible.bind(this)} itemsCarrito={this.itemsCarrito.bind(this)}/>}/>
          <Route path='/tienda/carrito' component={() => <Carrito contadorCarrito={this.contadorCarrito.bind(this)} itemsCarrito={this.itemsCarrito.bind(this)}/> }/>
        </div>
      </div>
    )
  }
    ...
    itemsCarrito(){
      ...
      return [];
      //return sessionStorage.getItem('Carrito')) ? JSON.parse(sessionStorage.getItem('Carrito')) : []                                                                  //Devolver 0 si no existen carritos
    }
    //--------------------Contador de items en menu---------------------------------
    contadorCarrito(){
      console.log(this.itemsCarrito().length)
